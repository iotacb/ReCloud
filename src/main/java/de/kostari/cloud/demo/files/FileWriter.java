package de.kostari.cloud.demo.files;
...
public class FileWriter {
    ...
    public static void appendString(File file, String content, int line) {
        ...
        List<String> fileContent = FileReader.readAsStringList(file);
    ...
    public static void mergeFiles(File file, File upperFile, File lowerFile) {
        List<String> upperFileContent = FileReader.readAsStringList(upperFile),
                lowerFileContent = FileReader.readAsStringList(lowerFile);
    ...
    public static void splitFile(File file, File filefileOne, File filefileTwo, int line) {
        ...
        List<String> content = FileReader.readAsStringList(file);
